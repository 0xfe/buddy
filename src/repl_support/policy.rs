...
use crate::repl_support::task_state::{format_elapsed, parse_duration_arg};
use buddy::runtime::RuntimeApprovalPolicy;
...
pub(crate) fn parse_approval_decision(input: &str) -> Option<ApprovalDecision> {
...
pub(crate) fn approval_policy_label(policy: ApprovalPolicy) -> String {
    match policy {
...
pub(crate) fn active_approval_decision(policy: &mut ApprovalPolicy) -> Option<ApprovalDecision> {
    match *policy {
...
pub(crate) fn update_approval_policy(
    input: &str,
...
pub(crate) fn to_runtime_approval_policy(policy: ApprovalPolicy) -> RuntimeApprovalPolicy {
    match policy {
